...
<div class="">
    ...
    <p>
        <input id="booleanField" name="booleanField" type="checkbox" value="1" <?php if($booleanField == "Yes") echo "checked" ?> />&nbsp;&nbsp;<label for="booleanField"><?php echo t("Boolean field"); ?></label>
    </p>
    <hr>
</div>